...
namespace Assignment
{
    public class AccountList
    {
        ...
        public bool isFirstTimeLogin(int accIndex)
        {
            ...
            if (allAccounts[accIndex].FirstTime)
            {
                return true;
            }
            else
        ...
        public void changingToNotFirstTime(int accIndex)
        {
            allAccounts[accIndex].FirstTime = false;
        }
        ...
        public void updateBodyWeightAndTargetChange (int currentIndex, double bWeight, double tCal)
        {
            allAccounts[currentIndex].BodyWeight = bWeight;
            allAccounts[currentIndex].TargetCalories = tCal;
        }
