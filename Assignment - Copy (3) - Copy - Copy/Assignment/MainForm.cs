...
namespace Assignment
{
    public partial class MainForm : Form
    {
        ...
        const double metWalk = 5;
        const double metSwim = 6;
        const double metBicycle = 8;
        const double metTennis = 7;
        const double metBasketball = 8;
        const double metWrestling = 6;
        ...
        // End of checkedChanged event handler functions

        // Handling of user guide visibility
        ...
        {
            bodyWeightText = txtNewWeight.Text;
            targetCaloriesText = txtNewTargetCalories.Text;
            ...
            {
                MessageBox.Show("Please enter a valid number for body weight.", "Invalid data", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            {
                MessageBox.Show("Please enter a valid number for tager calories.", "Invalid data", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        // The main function working on taking the values and displaying the amount of calorie burn
            ...
            if (chkBxWalking.Checked)
            {
                if (txtWalkingSteps.Text == "")
                {
                    if (txtWalkingDistance.Text == "")
                    {
                        ...
                        {
                            MessageBox.Show("Please enter at least one metric in walking", "Metric Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            return;
                        }
                        else
                        {
                            ...
                            total += result;
                            lblResult.Text = "You burn " + total.ToString("#.00") + " Calories";
                        }
                    }
                    else
                    {
            ...
            if (chkBxSwimming.Checked)
            {
                if (txtSwimmingHeartRate.Text == "")
                {
                    if (txtSwimmingNumOfLap.Text == "")
                    {
                        ...
                        {
                            MessageBox.Show("Please enter at least one information in swimming", "Metric Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            return;
                        }
                        else
                        {
                ...
                else
                {
                    if (txtSwimmingTimeTaken.Text == "")
                    {
                        MessageBox.Show(" You must enter the Time to calculate based on heart-rate for the Swimming", "Time taken required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
            ...
            if (chkBxBicycling.Checked)
            {
                if (txtBicyclingHeartRate.Text == "")
                {
                    if (txtBicyclingTimeTaken.Text == "")
                    {
                        ...
                        {
                            MessageBox.Show("Please enter at least one information in bicycling", "Metric Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            return;
                        }
                        else
                        {
                ...
                else
                {
                    if (txtBicyclingTimeTaken.Text == "")
                    {
                        MessageBox.Show(" You must enter the Time to calculate based on heart-rate for the Bicycling", "Time taken required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
            ...
            if (chkBxTennis.Checked)
            {
                if (txtTennisHeartRate.Text == "")
                {
                    if (txtTennisTime.Text == "")
                    {
                        ...
                        {
                            MessageBox.Show("Please enter at least one information in tennis.", "Metric Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            return;
                        }
                        else
                        {
                ...
                else
                {
                    if (txtTennisTime.Text == "")
                    {
                        MessageBox.Show(" You must enter the Time to calculate based on heart-rate for the Tennis", "Time taken Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
            ...
            if (chkBxBasketball.Checked)
            {
                if (txtBxBasketballHeartRate.Text == "")
                {
                    if (txtBxBasketballTimeTaken.Text == "")
                    {
                        ...
                        {
                            MessageBox.Show("Please enter at least one information in Basketball.", "Metric Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                        else
                        {
                ...
                else
                {
                    if (txtBxBasketballTimeTaken.Text == "")
                    {
                        MessageBox.Show(" You must enter the Time to calculate based on heart-rate for the Basketball", "Time taken Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
            ...
            if (chkBxWrestling.Checked)
            {
                if (txtBxWrestlingHeartRate.Text == "")
                {
                    if (txtBxWrestlingTimeTaken.Text == "")
                    {
                        ...
                        {
                            MessageBox.Show("Please enter at least one information in wrestling.", "Metric Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                        else
                        {
                ...
                else
                {
                    if (txtBxWrestlingTimeTaken.Text == "")
                    {
                        MessageBox.Show(" You must enter the Time to calculate based on heart-rate for the Wrestling", "Metric Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
