...
namespace Topic12Db2_1_ {
    ...
    public partial class MyDataDataSet : global::System.Data.DataSet {
        ...
        public partial class PeopleDataTable : global::System.Data.TypedTableBase<PeopleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PeopleRow AddPeopleRow(int Id, string UserName, string Address, string Comments, string Birthday) {
        ...
        public partial class PeopleRow : global::System.Data.DataRow {
            ...
            public string Comments {
                get {
                    try {
                        return ((string)(this[this.tablePeople.CommentsColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Comments\' in table \'People\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePeople.CommentsColumn] = value;
                }
            }
            ...
            public bool IsCommentsNull() {
                return this.IsNull(this.tablePeople.CommentsColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetCommentsNull() {
                this[this.tablePeople.CommentsColumn] = global::System.Convert.DBNull;
            }
...
namespace Topic12Db2_1_.MyDataDataSetTableAdapters {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[People] WHERE (([Id] = @Original_Id) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Comments = 1 AND [Comments] IS NULL) OR ([Comments] = @Original_Comments)) AND ((@IsNull_Birthday = 1 AND [Birthday] IS NULL) OR ([Birthday] = @Original_Birthday)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[People] ([Id], [UserName], [Address], [Comments], [Birthday]) " +
                "VALUES (@Id, @UserName, @Address, @Comments, @Birthday);\r\nSELECT Id, UserName, A" +
                "ddress, Comments, Birthday FROM People WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[People] SET [Id] = @Id, [UserName] = @UserName, [Address] = @Address, [Comments] = @Comments, [Birthday] = @Birthday WHERE (([Id] = @Original_Id) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Comments = 1 AND [Comments] IS NULL) OR ([Comments] = @Original_Comments)) AND ((@IsNull_Birthday = 1 AND [Birthday] IS NULL) OR ([Birthday] = @Original_Birthday)));
SELECT Id, UserName, Address, Comments, Birthday FROM People WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Topic12Db2_1_.Properties.Settings.Default.MyDataConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, UserName, Address, Comments, Birthday FROM dbo.People";
        ...
        public virtual int Fill(MyDataDataSet.PeopleDataTable dataTable) {
        ...
        public virtual MyDataDataSet.PeopleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyDataDataSet.PeopleDataTable dataTable = new MyDataDataSet.PeopleDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyDataDataSet.PeopleDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_UserName, string Original_Address, string Original_Comments, string Original_Birthday) {
        ...
        public virtual int Insert(int Id, string UserName, string Address, string Comments, string Birthday) {
        ...
        public virtual int Update(int Id, string UserName, string Address, string Comments, string Birthday, int Original_Id, string Original_UserName, string Original_Address, string Original_Comments, string Original_Birthday) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UserName, string Address, string Comments, string Birthday, int Original_Id, string Original_UserName, string Original_Address, string Original_Comments, string Original_Birthday) {
            return this.Update(Original_Id, UserName, Address, Comments, Birthday, Original_Id, Original_UserName, Original_Address, Original_Comments, Original_Birthday);
        }
    }
