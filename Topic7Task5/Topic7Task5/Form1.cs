...
namespace Topic7Task5
{
    public partial class Form1 : Form
    {
        ...
        {
            library = new Book[5];
            library[0] = new Book("Book1", "Author1", 1999);
            library[1] = new Book("Book2", "Author2", 2001);
            library[2] = new Book("Book3", "Author3", 1998);
            library[3] = new Book("Book4", "Author4", 2001);
            library[4] = new Book("Book5", "Author5", 2001);
