...
namespace Assignment
{
    public partial class ProfileSetUpForm : Form
    {
        ...
        private void cmdContinue_Click(object sender, EventArgs e)
        {
            ...
            string bodyWeightText = txtBodyWeight.Text;
            string targetCaloriesText = txtTargetCalories.Text;
            ...
            {
                MessageBox.Show("Please fill in all the required fields.", "Incorrect Password", MessageBoxButtons.OK, MessageBoxIcon.Error);
